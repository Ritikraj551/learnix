...
function EditLecture() {
  ...
  const [isePreviewFree, setIsPreviewFree] = useState(false);
  ...
  formData.append("isPreviewFree", isePreviewFree);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <button disabled={loading1} onClick={removeLecture} className="mt-2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-all text-sm">
          {loading1 ? (
