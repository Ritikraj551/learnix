...
function AllCourses() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* sidebar */}
      <aside className={`w-[260px] h-screen overflow-y-auto bg-black fixed top-0 left-0 py-[130px] border-r border-gray-200 shadow-md transition-transform duration-300 z-5 ${isSidebarVisible?"translate-x-0":"-translate-x"} md:block md:translate-x-0`}>
