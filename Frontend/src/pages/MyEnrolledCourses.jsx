            ...
            >
              ...
              <div className="p-4">
                ...
                <h1
                  ...
                  className="px-2.5 text-center py-2.5 border-2 bg-black border-black text-white rounded-[10px] text-[15px] font-light cursor-pointer mt-2.5 hover:bg-gray-600"
                >
                  Watch Now
                </h1>
              </div>
